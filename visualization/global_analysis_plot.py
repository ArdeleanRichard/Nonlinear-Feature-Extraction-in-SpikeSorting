...
if __name__ == "__main__":
    ...
    methods_dict = {
        ...
        # "Keppler\nMapper":       filter_columns_and_save(f"{FOLDER}kmapper_kmeans.csv", columns=columns),
        'Isomap':               filter_columns_and_save(f"{FOLDER}/isomap_kmeans.csv", columns=columns),
        'Spectral\nembedding':   filter_columns_and_save(f"{FOLDER}/spectral_kmeans.csv", columns=columns),
        "t-SNE":                filter_columns_and_save(f"{FOLDER}tsne_kmeans.csv", columns=columns),
        "Diffusion\nMap":        filter_columns_and_save(f"{FOLDER}diffusion_map_kmeans.csv", columns=columns),
